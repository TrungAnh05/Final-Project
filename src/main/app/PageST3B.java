...
public class PageST3B implements Handler {
  ...
  public void handle(Context context) throws Exception {
    ...
    html.append("<h1> A Focused View Of Date On a Country, City or State Level </h1>");

    // page description
    html.append(
        "<p> On this page, choose country, city, or state data. For countries, view population, temperature, or both. For cities or states, only  </p>");
    html.append(
        "temperature available. Compare by relative change or absolute value. Select similar locations to compare, choosing how many.");
