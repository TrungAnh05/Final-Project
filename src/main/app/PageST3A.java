...
public class PageST3A implements Handler {
  ...
  public void handle(Context context) throws Exception {
    ...
    html = html + """
        <h1>Identify changes in temperature over extended periods</h1>
        """;

    html = html
        + "<p>This page enables selecting and comparing average temperatures across time periods and geographic locations. See firsthand how "
        + " climate change has influenced temperature shifts throughout history.</p>";
