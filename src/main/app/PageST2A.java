...
public class PageST2A implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + """
                <h1>Focused view of temperature and population change by Country/World</h1>
                """;

        html = html
                + "<p>This page allows you to look at specific global temperature and population change over a time period or compare changes in country "
                +
                " population and temperature change. As a result you can find ways in which population change has affected temperature change on a"
                +
                " large scale.";
